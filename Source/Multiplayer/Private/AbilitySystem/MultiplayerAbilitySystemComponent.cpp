...
void UMultiplayerAbilitySystemComponent::AddAbility(int32 SlotIndex, UAbilityInfo* AbilityInfo)
{
...
void UMultiplayerAbilitySystemComponent::InitializeAbilities(const TMap<int32, UAbilityInfo*>& StartingAbilities)
{
...
bool UMultiplayerAbilitySystemComponent::ActivateAbility(int32 SlotIndex)
{
