...
UAbilitySystemComponent* UBaseGameplayAbility::GetAbilitySystemFromActorInfo() const
{
	return CurrentActorInfo
		       ? Cast<UAbilitySystemComponent>(CurrentActorInfo->AbilitySystemComponent.Get())
		       : nullptr;
}
