...
void AMultiplayerCharacter::DoMove(float Right, float Forward)
{
...
void AMultiplayerCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AMultiplayerCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AMultiplayerCharacter::DoJumpEnd()
{
